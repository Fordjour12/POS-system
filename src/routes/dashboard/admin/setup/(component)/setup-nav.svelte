...
>
    <a href="/dashboard/admin/setup" class="font-semibold text-primary">
        General Setup
    </a>
    <a href="/dashboard/admin/setup/categories">categories </a>
    <a href="/dashboard/admin/setup/drinks">Drinks</a>
    <a href="/dashboard/admin/setup/meal">Meal</a>
</nav>
